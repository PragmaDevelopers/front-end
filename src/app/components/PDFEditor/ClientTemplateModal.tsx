    ...
    return (
        <div className="flex flex-col z-50 mt-3 w-2/3 bg-neutral-50 drop-shadow rounded-md p-3">
            <form onSubmit={(e:any)=>{
                ...
                fetch(`${API_BASE_URL}/api/private/user/signup/client/templates?value=true&name=${name}&page=${page}`, requestOptions)
            ...
            <form onSubmit={(e: any) => {
                e.preventDefault();
                if (selectedTemplate?.id != undefined && !currentTemplateList.some(currentTemplate=>currentTemplate.id==selectedTemplate.id)) {
                    setCurrentTemplateList([...currentTemplateList,selectedTemplate]);
                }
                ...
                </div>
                {
                    currentTemplateList.length > 0 && (
                        <>
                            <div className="bg-neutral-200 h-1 rounded-md mt-3 mb-3"></div>
                            <div className="overflow-y-scroll flex w-full gap-3">
                                {
            ...
            <form onSubmit={(e: any) => {
                ...
                <div className="w-full flex gap-3 items-center">
                    ...
                    <button className={`w-1/4 bg-neutral-100 drop-shadow rounded-md p-2 text-center`}>Deletar</button>
                </div>
            </form>
        </div>
    )
