            ...
            <div className={(showNotification ? "block" : "hidden") + " w-full h-full bg-transparent z-10 absolute top-20 left-0 bg-neutral-950/50"}>
                <div className="w-full h-full relative">
                    <div className="bg-neutral-50 drop-shadow-lg rounded-md w-96 m-4 absolute top-0 right-8 last:border-none">
                        <div className="p-2 last:border-none odd:border-b-2 odd:border-neutral-400 even:border-b-2 even:border-neutral-400">
                        ...
                        <Link href="/dashboard/notifications" className="text-blue-300 hover:text-blue-500 transition-all">Ver todas as notificações</Link>
                    </div>
                </div>
            </div>
