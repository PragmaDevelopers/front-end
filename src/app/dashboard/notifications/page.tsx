    ...
    return (
        <Link href="#" className="w-full h-16 bg-neutral-transparent hover:bg-neutral-50/25 transition-all block overflow-x-hidden">
            <div className="w-full h-full px-4 py-2 flex flex-row justify-between items-center">
                <div className="w-8 mr-2 aspect-square">
                    <UserCircleIcon className="w-full h-full fill-neutral-950 stroke-neutral-950" />
                </div>
    ...
    return (
        <main className="w-full h-full flex flex-col">
            ...
            <div className="w-full h-full flex flex-row justify-start items-start">
                ...
                <div className="w-[58%] h-[85%] shadow-inner border-[1px] border-neutral-300 bg-neutral-200 ml-4 mr-4 mt-4 mb-8 rounded-md divide-y divide-neutral-400 overflow-auto">
                    <NotificationElement />
                    <NotificationElement />
                    <NotificationElement />
                    <NotificationElement />
