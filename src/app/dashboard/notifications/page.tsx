...
function NotificationElement() {
    return (
        <Link href="#" className="w-[96%] h-16 bg-neutral-transparent hover:bg-neutral-100/25 transition-all block overflow-x-hidden">
...
export default function Page() {
    return (
        <main className="w-full h-[80vh] flex flex-col">
            <h1 className="font-bold text-xl my-4">Notificações</h1>
            <div className="w-full h-full flex flex-row justify-between items-center">
                <div className="h-full m-4 shadow-inner border-[1px] border-neutral-300 bg-neutral-200 rounded-md w-[20%]">
                    <h1>Menu</h1>
                </div>
                <div className="w-[75%] h-full shadow-inner border-[1px] border-neutral-300 bg-neutral-200 m-4 rounded-md divide-y divide-neutral-400 overflow-auto">
                    <NotificationElement />
                    <NotificationElement />
                    <NotificationElement />
                    <NotificationElement />
